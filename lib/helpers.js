...
class FilteredUsers {
    ...
    static async getAll() {
        ...
        let res = await api.storage.sync.get("filteredUsers");
    ...
    static async add(username, reason=null) {
        ...
        await api.storage.sync.set({filteredUsers: newUsers});
    }
    ...
    static async remove(username) {
        ...
        await api.storage.sync.set({filteredUsers: users});
    }
...
class HighlightedUsers {
    ...
    static async getAll() {
        ...
        let res = await api.storage.sync.get("highlightedUsers");
    ...
    static async add(username, reason=null) {
        ...
        await api.storage.sync.set({highlightedUsers: users});
    }
...
class FilterMode {
    ...
    static async get() {
        ...
        let res = await api.storage.sync.get("filterMode");
    ...
    static async set(mode) {
        ...
        await api.storage.sync.set({filterMode: mode});
    }
}
...
class SafetyFilter {
    ...
    static async get() {
        ...
        let res = await api.storage.sync.get("safeMode");
    ...
    static async set(mode) {
        ...
        await api.storage.sync.set({safeMode: mode});
    }
}
...
class SortMode {
    ...
    static async get() {
        /**
         * Get the sort mode from storage.
         * */

        let res = await api.storage.sync.get("sortMode");
        return res.sortMode || "r";
    }
    ...
    static async set(mode) {
        ...
        await api.storage.sync.set({sortMode: mode});
    }
}
