...
class YCHCategory {
    ...
    static async loadSettings() {
        ...
        if(!compareArrays(filteredUsers, settingsFilteredUsers) || !compareArrays(highlightedUsers, settingsHighlightedUsers)) {
            ...
            document.querySelectorAll(".ek4c-hidden").forEach(i => {
                i.classList.remove("ek4c-hidden");
            });
            document.querySelectorAll(".ek4c-highlighted").forEach(i => {
                i.classList.remove("ek4c-highlighted");
            });
        }
