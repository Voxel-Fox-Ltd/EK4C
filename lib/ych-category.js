...
class YCHCategory {
    ...
    static async setupTabs() {
        /**
         * Setup the tabs for ych.commishes.
         * */

        let sortMode = await SortMode.get();
        let getParam = ""
        if(sortMode == "r") {
            getParam = "?order=heat"
        }
        ...
        for(let i of document.querySelectorAll(".tabs a.tab")) {
            i.href = i.href + getParam;
        }
    }
